...
import { ENDPOINTS, NGROK_HEADERS, getAttributionLive } from './api_config';
...
export default function App() {
  ...
  const handleForceRefresh = useCallback(() => {
    ...
    setIsRefreshing(true); // For UI spinner state

    getAttributionLive(currentStation)
      .then((data) => {
        if (data?.trigger_station?.reading) {
          // Complete state object replacement to force deep-comparison leaf node re-render
  ...
  }, [currentStation]); // Only currentStation as dependency
